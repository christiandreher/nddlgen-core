...
namespace nddlgen { namespace core
{
	...
	NddlGenerator::NddlGenerator(nddlgen::models::Arm* armModel, nddlgen::utilities::ControllerConfig* controllerConfig)
	{
	...
	bool NddlGenerator::generateModels(std::string fileName)
	{
		...
		std::string adapter = this->_controllerConfig->getAdapter();
		std::string outputFile = this->_controllerConfig->getOutputModelFileName();
		std::string inputSdfFile = this->_controllerConfig->getInputSdfFileName();
		std::string inputSdfFilePath = this->_controllerConfig->getInputIsdFileName();
