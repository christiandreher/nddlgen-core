...
namespace nddlgen { namespace controller
{
	...
	nddlgen::models::DomainDescriptionModel* DomainDescriptionFactory::build(nddlgen::types::SdfRoot sdfRoot,
	...
	void DomainDescriptionFactory::instantiateWorkspace(nddlgen::models::DomainDescriptionModel* domainDescription)
	{
	...
	void DomainDescriptionFactory::populateModelListFromSdf(sdf::ElementPtr modelElements,
			nddlgen::types::ModelList* models)
	{
	...
	void DomainDescriptionFactory::addRelevantModelsToWorkspace(nddlgen::models::DomainDescriptionModel* domainDescription,
			nddlgen::types::ModelList models)
	{
	...
	void DomainDescriptionFactory::calculateDependencies(nddlgen::models::DomainDescriptionModel* domainDescription,
			nddlgen::types::ModelList models)
	{
	...
	nddlgen::models::NddlGeneratable* DomainDescriptionFactory::instanceFactory(sdf::ElementPtr element)
	{
		...
		return nddlgen::controller::NddlGeneratableFactory::fromString(elementName);
	}
