...
namespace nddlgen { namespace controller
{
	...
	NddlGenerationController::NddlGenerationController()
	{
	...
	void NddlGenerationController::writeModelFile(nddlgen::models::DomainDescriptionModel* domainDescription,
	...
	void NddlGenerationController::writeInitialStateFile(nddlgen::models::DomainDescriptionModel* domainDescription,
			nddlgen::utilities::WorkflowControllerConfig* controllerConfig)
	{
		// Open output file stream
	...
	std::string NddlGenerationController::getPrettifiedDate()
	{
		// Get POSIX time
